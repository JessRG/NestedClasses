...
//        employees.sort(comparator);
    ...
    // this function will accept a list of StoreEmployee items or any subtype
    // of StoreEmployee
    public static void addPigLatinName(List<? extends StoreEmployee> list) {

        // local variable that is only assigned here
        // this is effectively final unless reassigned somewhere in the method
